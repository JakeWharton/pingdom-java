/**
 * <p>All Pingdom-defined enumerations which are used both in request responses
 ...
 * the {@link com.jakewharton.pingdom.PingdomEnumeration} interface in order to
 * be properly serialized.</p>
 *
 * <p>Deserialization of an enumerable value requires registration with the
 * GSON builder in the
 * {@link com.jakewharton.pingdom.PingdomApiService#getGsonBuilder()} method.
